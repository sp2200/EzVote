...
class displaymultiple extends StatefulWidget {
  final String dID;
  displaymultiple(this.dID);
  @override
  _displaymultiple createState() => _displaymultiple(documentID: dID);
}

class _displaymultiple extends State<displaymultiple> {
  final String documentID;
  _displaymultiple({Key key, @required this.documentID});
                  ...
                  Center(
                    child: Column(
                      children: <Widget>[
                        ...
                        StreamBuilder(
                          stream: Firestore.instance.collection('Multiple Options').document(documentID).snapshots(),
