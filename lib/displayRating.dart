...
class displayRating extends StatefulWidget {
  final String dID;
  displayRating(this.dID);
  @override
  _displayRating createState() => _displayRating(documentID: dID);
}

class _displayRating extends State<displayRating> {
  final String documentID;
  _displayRating({Key key, @required this.documentID});
                  ...
                  Center(
                    child: Column(
                      children: <Widget>[
                        ...
                        StreamBuilder(
                            stream: Firestore.instance.collection('Rating').document(documentID).snapshots(),
